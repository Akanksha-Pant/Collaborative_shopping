    ...
    return (
      ...
      <div className = "card">
        ...
        <div className = "AboutProduct">
          <div className = "ProductName"> <h2>Athena</h2></div>
          <div className = "ProductDescription"><h2>Women Olive Green Solid Top</h2></div>
          <div className = "ProductPrice"><h2>MRP 700</h2></div>
